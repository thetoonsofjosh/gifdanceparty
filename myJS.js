...
"json", "ajaxSubmit", "#submit_background_form", ".submit_background_button", "success", "uploaded_backgrounds/", "setBG", "resetForm", "err", "upload error", "Getting URL...", "#input_shareURL", "http://", "host", "location", "?", "getShare", "param", "https://api-ssl.bitly.com/v3/shorten?access_token=", "&domain=gph.is", "SHARING ERROR", "status_code", "200", "url", "data-clipboard-text", "#copy_button", "ajax", "&longUrl=", "js/ZeroClipboard.swf", "config", "copy_button", "getElementById", "noflash", 
